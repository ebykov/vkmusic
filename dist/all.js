...
exports.default = {
    ...
    description: "<p>Во «ВКонтакте» регулярно появляются молодые инди&#8209;музыканты, которые затем вырастают до звёзд, о которых говорят чуть ли не все. Вместе с некоторыми из них <b>Монеточка</b>, <b>Noize MC</b>, <b>FACE</b> мы сделали подборку семплов и треков. А ваша задача — их угадать.</p>",
    art: [{
        x: 10,
        y: 5,
        size: 5,
    ...
    _createClass(Player, [{
        ...
        value: function createPlayer() {
            EL.player = (0, _dom.makeElement)('div', 'VKMusic-audio'), EL.btn = (0, _dom.makeElement)('div', 'VKMusic-audio__btn'), EL.path = (0, _dom.makeElement)('div', 'VKMusic-audio__path'), EL.pathProgress = (0, _dom.makeElement)('div', 'VKMusic-audio__path-progress'), EL.time = (0, _dom.makeElement)('div', 'VKMusic-audio__time', {
                textContent: '0:00'
            }), EL.audio = (0, _dom.makeElement)('audio', null, {
                type: 'audio/mpeg'
            }), EL.source = (0, _dom.makeElement)('source');
        ...
        value: function onProgress(e) {
            var num = Math.round(100 / e.target.duration * e.target.currentTime * 10000) / 10000;
